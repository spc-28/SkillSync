...
const SignUpForm: React.FC<SignUpFormProps> = ({ formData, colleges, showPassword, setShowPassword, handleInputChange, handleSubmit, loading }) => {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="space-y-5">
          ...
          <button
            ...
            className="w-full py-3 cursor-pointer bg-indigo-600 text-white rounded-xl font-semibold hover:bg-indigo-700 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
            disabled={loading}
          >
